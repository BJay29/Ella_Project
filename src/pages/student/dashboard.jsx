  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-full bg-[#E5E5E5] overflow-hidden font-sans relative">
      ...
      `}>
        ...
        <div className="mt-auto self-center pb-10 md:pb-0">
          <img 
      ...
      <main className="flex-1 flex flex-col p-4 md:p-10 overflow-hidden w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 md:mb-10 gap-4 flex-shrink-0">
          <div className="flex items-center gap-3 md:gap-4 w-full sm:w-auto">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full border-2 border-black bg-white flex items-center justify-center text-[8px] md:text-[10px] font-bold flex-shrink-0">
              Avatar
            </div>
            <div>
        ...
        {/* Quest Container */}
        {activePage === 'Home' && (
          <div className="bg-[#1B5E20] rounded-[20px] md:rounded-[30px] p-4 md:p-8 shadow-xl max-w-4xl mx-auto border-2 border-black/10 w-full 
          flex flex-col overflow-hidden h-full max-h-[80vh] md:max-h-full">
            <div className="bg-[#2E7D32] border border-black text-white py-1 px-8 md:px-12 rounded-full w-max mx-auto mb-4 md:mb-6 text-[10px]
             md:text-xs font-bold uppercase tracking-widest flex-shrink-0">
              Quest
            </div>
              ...
              {quests.map((quest) => (
                <div key={quest.id} className="border-b border-black/10 last:border-0">
                  <div 
                    ...
                    className="flex justify-between items-center py-2 md:py-3 px-2 cursor-pointer hover:bg-sky-300/30 rounded-lg transition-all"
                  >
                  ...
                  {selectedQuest === quest.id && (
                    <div className="flex justify-center pb-3 md:pb-4 pt-1 animate-fadeIn">
                      <button 
                        className="bg-[#2E7D32] text-white px-6 md:px-8 py-1.5 rounded-lg border border-black text-xs md:text-sm font-bold hover:bg-[#1B5E20] shadow-sm transition-all"
