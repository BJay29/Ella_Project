...
const InstructorDashboard = () => {
  ...
  // Auth guard is now handled cleanly by <ProtectedRoute> in App.jsx
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <button className="mt-6 flex items-center font-black text-sm uppercase group-hover:gap-3 transition-all">
                        View details{' '}
                        <span className="ml-2 bg-black text-white rounded-full w-6 h-6 flex items-center justify-center text-[10px]">
                          ➝
                        </span>
                      </button>
                    </div>
