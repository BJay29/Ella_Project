...
export const authAPI = {
    ...
    // Step 1: Initiate Google Login (Redirects the whole page)
    initiateGoogleLogin: () => {
        window.location.href = `${BASE_URL}/api/user/google`;
    },

    // Step 2: Callback Handler (Optional, usually handled by backend redirect)
    ...
    // Inalis na ang code requirement dito
