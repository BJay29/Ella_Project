...
const InstructorDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#d9ead3] font-sans text-black relative">
      ...
      {/* SIDEBAR - Pinapasa ang function para buksan ang modal */}
      <InstructorSidebar 
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[999] p-6">
          <div className="bg-[#C1E1C1] w-full max-w-[450px] p-12 rounded-[50px] shadow-2xl flex flex-col items-center border border-white/20 animate-in zoom-in duration-200">
            ...
            <div className="flex gap-6 w-full justify-center">
              {/* YES BUTTON - REDIRECT TO INSTRUCTOR LOGIN */}
              <button 
                onClick={() => navigate("/instructor/login")}
                className="w-32 py-3 bg-[#718E5A] text-white rounded-full font-bold text-lg shadow-lg hover:bg-[#5f7a4a] transition-all active:scale-95"
              >
                Yes
              </button>
              ...
              <button 
                ...
                className="w-32 py-3 bg-[#A2C371] text-white rounded-full font-bold text-lg shadow-lg hover:bg-[#8eb05f] transition-all active:scale-95"
              >
                No
              </button>
            </div>
